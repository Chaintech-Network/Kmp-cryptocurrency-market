...
@NonNullApi
public class BinancePriceTickerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BinancePriceTickerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
